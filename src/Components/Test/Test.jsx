            ...
            {products
              ...
              .map((filteredProduct, index) => (
                <div key={index}>
                  ...
                  <img
                    src={filteredProduct.gallery[0]}
                    alt={filteredProduct.name}
                    style={{ width: "100px" }}
                  />
                  <p>{filteredProduct.description}</p>
                  <p>
                    Price: {filteredProduct.prices[0].currency.symbol}
                    {filteredProduct.prices[0].amount}
                  </p>
                  <p>
                    Status:{" "}
                    {filteredProduct.inStock ? "In Stock" : "Out of Stock"}
                  </p>
                </div>
              ))}
          </div>
